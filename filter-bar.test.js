/**
 * Tests for assets/filter-bar.js (window.AAIC_FILTERS).
...
// Load filter-bar.js into a fresh jsdom window and return window.AAIC_FILTERS.
function loadModule(url) {
  ...
  const { window } = dom;
  window.eval(src);
  return { window, F: window.AAIC_FILTERS };
}
