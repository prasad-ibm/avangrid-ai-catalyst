 ...
 *   - the stage -> column bucketing model (window.AAIC_KANBAN)
...
console.log('== 1. Model surface (window.AAIC_KANBAN) ==');
let dom = newDom();
let K = dom.window.AAIC_KANBAN;
ok('window.AAIC_KANBAN exists', !!K);
...
console.log('\n== 9. Workspace picker populated + Avangrid preselected ==');
dom = newDom();
await tick(); await tick();
