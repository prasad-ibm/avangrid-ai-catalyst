 ...
 *   - the pure compare model (window.AAIC_COMPARE): verdict class mapping,
...
const PORTFOLIO = [
  { id: 'uc-1', name: 'Fraud Signal Triage', department: 'Risk & Compliance',
    ...
    recommended_platform: 'Azure AI Foundry', citizen_dev_pct: 30 },
  { id: 'uc-2', name: 'Contract Summarizer', department: 'Legal',
    ...
    recommended_platform: 'Copilot', citizen_dev_pct: 55 },
  ...
  { id: 'uc-4', name: 'Ticket Router', department: 'Support',
    ...
    recommended_platform: 'Azure AI Foundry', citizen_dev_pct: 25 },
  { id: 'uc-5', name: 'Sales Copilot', department: 'Sales',
    stage: 'bxt', feasibility_composite: 3.5, roi_p10: 10, roi_p50: 40, roi_p90: 80,
    verdict: 'GO', quadrant: 'Quick Win', advisory_tier: 'Extend',
    recommended_platform: 'Copilot', citizen_dev_pct: 40 },
];

const WORKSPACES = [
  { id: 'ws-avangrid', name: 'Avangrid Corp' },
...
console.log('== 1. Model surface (window.AAIC_COMPARE) ==');
let dom = newDom();
let C = dom.window.AAIC_COMPARE;
ok('window.AAIC_COMPARE exists', !!C);
...
const LONG_PORTFOLIO = [
  { id: 'uc-long', name: LONG, department: 'Ops', stage: 'panel',
    ...
    recommended_platform: 'Azure AI Foundry', citizen_dev_pct: 10 },
].concat(PORTFOLIO);
