 ...
 * existing Avangrid use cases as example rows. Columns map to the use_cases table
 ...
 *
 * Example values are drawn faithfully from scripts/seed-avangrid.js.
 */
...
// The 5 Avangrid use cases, mapped from scripts/seed-avangrid.js into the flat
...
const TEMPLATE_ROWS = [
  {
    ...
    contact_email: 'askhr@avangrid.com',
    ...
    integrations: 'Microsoft 365 Copilot; Copilot Studio',
    realtime: 'No',
  ...
  },
  {
    ...
    contact_email: 'procurement@avangrid.com',
    ...
    integrations: 'Power Apps / Copilot Studio + Azure AI Foundry + Document AI + Microsoft Fabric',
  ...
  },
  {
    ...
    contact_email: 'supplychain@avangrid.com',
    ...
    sources: 'IBP demand history, external signals, Microsoft Fabric',
    dataavail: 'Available; external ingestion effort',
    integrations: 'Azure AI Foundry Forecasting + Microsoft Fabric ML',
  ...
  },
  {
    ...
    integrations: 'Azure AI Foundry + Pub/Sub + Microsoft Fabric + Cloud Functions',
  ...
  },
  {
    ...
    contact_email: 'quality@avangrid.com',
    ...
    sources: 'QM inspection, MES process params, Microsoft Fabric',
    dataavail: 'Available; MES integration effort',
    integrations: 'Azure AI Foundry + Microsoft Fabric ML + Looker',
  ...
  },
  {
    ...
    contact_email: 'ap-automation@avangrid.com',
    ...
    dataavail: 'Readily available & clean',
    integrations: 'Document AI; Microsoft Fabric; ERP connector',
    realtime: 'No',
...
// Build the full CSV: header row + one row per Avangrid example. CRLF line endings
