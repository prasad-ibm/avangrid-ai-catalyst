# Avangrid AI Catalyst

![CI](https://github.com/prasad-ibm/avangrid-ai-catalyst/actions/workflows/ci.yml/badge.svg)
...
frameworks (Azure Well-Architected Framework, Microsoft Cloud Adoption Framework,
McKinsey × MIT Sloan, Gartner) using the organisation's own context.

> Avangrid-branded reskin of the AI Catalyst concept. All cloud/AI references map to
> Microsoft Azure products — Azure AI Foundry, Copilot, Copilot Studio, Power Apps, Microsoft Fabric.

## Features

- **Enterprise onboarding** — 7-step workspace setup wizard with a live "AI Context
  Preview" sidebar (organisation, tech stack, Microsoft 365, IT capability,
...
- **6-gate evaluation pipeline:**
  ...
  4. **Platform Advisory** — Azure Well-Architected Framework: Adopt → Extend → Build ladder
...
- **Frontend:** static HTML/CSS/JS, Avangrid design system (`assets/theme.css`),
  Segoe UI / Cascadia Mono, dark theme. No build step.
...
```bash
git clone <your-repo-url> avangrid-ai-catalyst
...
password: AvangridUser1!
```

## Seed demo data (optional)

Seeds an **Avangrid** enterprise plus 5 use cases fully populated across all 5
...
├── advisory.html         Gate 4 — Platform advisory (AWAF)
├── summary.html          Gate 5 — Evaluation summary (Monte Carlo ROI)
├── panel.html            Gate 6 — Executive review panel
├── assets/
│   ├── theme.css         Avangrid design system
│   └── api-client.js     window.AAIC_API (API + localStorage fallback)
...
│   ├── seed-avangrid.js     Seed Avangrid workspace + 5 use cases
│   └── seed-demo-300.js     Optional large portfolio demo (N synthetic cases)
