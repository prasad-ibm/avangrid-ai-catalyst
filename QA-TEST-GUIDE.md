...
**Demo data:** switch the workspace picker to **"Avangrid - Portfolio Demo"** (300 evaluated use cases across 14 departments, ~35 marked *Delivered* in 2026).
...
- [ ] With **"Avangrid - Portfolio Demo"** selected, the **"2026 Delivered"** section is visible.
...
- AI narrative features run in **scripted** mode on the demo (no live Copilot) — deliberation text is deterministic, which is expected.
