# Avangrid AI Catalyst — Data Model (Product Manager's Guide)
...
|-------|----------------------|
| `name` | Enterprise name (e.g. "Avangrid") |
...
| `cloud_provider` | Primary cloud (defaults to **Microsoft Azure**) |
| `workspace_edition` | Microsoft 365 SKU — gates Copilot eligibility |
| `gemini_seats` | Microsoft 365 Copilot licences purchased |
| `monthly_gcp_consumption` | Microsoft Azure spend band — infra maturity signal |
| `appsheet_plan` | Low-code / citizen-developer capability |
| `vertex_approved` | Azure AI Foundry production access (prerequisite for Build tier) |
...
| `recommended_platform` | Suggested Avangrid platform/product |
