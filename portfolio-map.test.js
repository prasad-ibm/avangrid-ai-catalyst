...
console.log('\n== 9. Zero foreign-vendor strings ==');
['Google','Gemini','Vertex','AppSheet','Agentspace','BigQuery','GADF','watsonx','Agentforce','Salesforce']
  .forEach(m => ok('NO foreign-vendor string "' + m + '"',
