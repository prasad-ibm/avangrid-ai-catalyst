/*
 * AAIC bulk use-case upload — additive, optional. Exposes window.AAIC_BULK.
 *
 ...
 * then call window.AAIC_BULK.mount({ open: '#bulkUploadBtn' }).
 */
(function (root, factory) {
  'use strict';
  var api = factory();
  // Browser global.
  if (typeof window !== 'undefined') window.AAIC_BULK = api;
  ...
  function injectStyles() {
    ...
    var css =
      ...
      '.gbu-link{color:var(--g-blue-l,#5FBF7F);text-decoration:underline;}' +
      ...
      '.gbu-select:hover{border-color:var(--g-blue-l,#5FBF7F);}' +
